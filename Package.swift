...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "git@git.isis.vanderbilt.edu:proteus/CEnergymon", .exact("1.0.1")),
    .package(url: "git@git.isis.vanderbilt.edu:proteus/FASTController", .exact("1.0.3")),
    .package(url: "https://github.com/PerfectlySoft/Perfect-HTTPServer", .exact("3.0.10")),
    .package(url: "git@git.isis.vanderbilt.edu:proteus/swift-ast", .exact("0.2.0")),
  ],
  targets: [
